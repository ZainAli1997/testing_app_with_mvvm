...
class Palette {
  static const MaterialColor themecolor = MaterialColor(
    0xfff17364, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
      50: Color(0xfffd7d6d), //10%
